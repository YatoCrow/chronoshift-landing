...
const keywordData = [
  ...
  { term: "Spell – Rite", def: "Can only be played during your main phase. Rite spells tend to be powerful, but slower and more deliberate.", tags: ["Subtype"] },
  { term: "Spell – Burst", def: "Can be played at any time, including your opponent’s turn. Burst spells allow tactical responses and disruption.", tags: ["Subtype"] },
  { term: "Spell – Dispel", def: "Can only be played in response to another spell or Figure being played. Dispel spells cancel the target spell if successful.", tags: ["Subtype"] },
