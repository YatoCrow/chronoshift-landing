  ...
  return (
    <div className="rules-page">
      ...
      <CollapsibleRuleSection title="Game Overview">
        <p><strong>Chronoshift: Eclipse Dawn</strong> is a strategic, time-shifting fantasy trading card game. Players command powerful factions, each aligned with a unique phase of time: Night, Full Moon, Day, Scorch, or Dusk, and seek to reduce their opponent’s HP from <strong>30 to 0</strong>.</p>
